...
if((Test-Path c:\temp) -eq $false) {
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Create C:\temp Directory"
    Write-Host `
    ...
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "C:\temp Already Exists"
    Write-Host `
...
if((Test-Path $LocalWVDpath) -eq $false) {
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Create C:\temp\WVD Directory"
    Write-Host `
        -ForegroundColor Cyan `
        -BackgroundColor Black `
    ...
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "C:\temp\WVD Already Exists"
    Write-Host `
        -ForegroundColor Yellow `
        -BackgroundColor Black `
        "c:\temp\wvd directory already exists"
}
New-Item -Path c:\ -Name New-Nordlo-WVDSessionHost.log -ItemType File
Add-Content `
-LiteralPath C:\New-Nordlo-WVDSessionHost.log `
"
...
#################################
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Downloading WVD Boot Loader"
    Invoke-WebRequest -Uri $WVDBootURI -OutFile "$LocalWVDpath$WVDBootInstaller"
#Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Downloading FSLogix"
    #Invoke-WebRequest -Uri $FSLogixURI -OutFile "$LocalWVDpath$FSInstaller"
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Downloading WVD Agent"
...
##############################
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Unzip FSLogix"
Expand-Archive `
...
cd $LocalWVDpath 
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "UnZip FXLogix Complete"
#>
...
If(($OS) -match 'server') {
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Windows Server OS Detected"
...
Else {
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Windows Client OS Detected"
    ...
    if(($OS) -match 'Windows 10') {
        ...
        Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Windows 10 Detected...skipping to next step"     
    }    
    else {
        ...
        If(($OSArch) -match '64-bit') {
            ...
            Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Windows 7 x64 Detected"
...
################################
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Installing WVD Bootloader"
...
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Installing WVD Bootloader Complete"
Write-Output "Installing RDAgentBootLoader on VM Complete. Exit code=$sts`n"
Wait-Event -Timeout 5
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Installing WVD Agent"
...
$agent_deploy_status = Start-Process `
    ...
    -Wait `
    -Passthru
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "WVD Agent Install Complete"
Wait-Event -Timeout 5
...
#    FSLogix Install    #
#########################
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Installing FSLogix"
...
#######################################
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Configure FSLogix Profile Settings"
Push-Location 
...
##########################################
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Enable Screen Capture Protection"
Push-Location 
...
If ($Optimize -eq $true) {  
    ...
    ################################
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Optimize Selected"
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Creating C:\Optimize folder"
    ...
    ###############################
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Optimize downloaded and extracted"
    Expand-Archive `
    ...
    #################################
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Begining Optimize"
    Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Force -Verbose
    .\Win10_VirtualDesktop_Optimize.ps1 -WindowsVersion 2004 -Verbose
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Optimization Complete"
}
else {
    Write-Output "Optimize not selected"
    Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Optimize NOT selected"    
}
#>
...
#    Restart Computer    #
##########################
Add-Content -LiteralPath C:\New-Nordlo-WVDSessionHost.log "Process Complete - REBOOT"
